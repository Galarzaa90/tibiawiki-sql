...
def init_database(con):
    """Initialize all database tables, dropping and recreating them."""
    _init_db_info(con)
    _init_creatures(con)
    _init_items(con)
    _init_imbuements(con)
    _init_imbuements_materials(con)
    _init_creatures_drops(con)
    _init_items_attributes(con)
    _init_npcs(con)
    _init_npcs_buying(con)
    _init_npcs_selling(con)
    _init_npcs_destinations(con)
    _init_spells(con)
    _init_npcs_spells(con)
    _init_houses(con)
    _init_achievements(con)
    _init_quests(con)
    _init_map(con)
    _init_quests_rewards(con)
    _init_quests_dangers(con)
    _init_rashid_positions(con)
    _init_items_keys(con)
    _init_charm(con)
...
def _init_rashid_positions(con):
...
def _init_npcs_destinations(con):
...
def _init_items_attributes(con):
...
def _init_imbuements_materials(con):
